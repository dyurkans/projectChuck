class Registration < ActiveRecord::Base
  ...
  validates_date :physical_date,:allow_nil=> true, :on_or_after => lambda { Date.new(Date.today.year-1, 8, 1) }, :on_or_before => lambda { Date.today }, :on_or_before_message => "Physical date cannot be in the future"
